...
students_ice_cream_heights <- inner_join(ice_cream, heights, by = c("student_IDs" = "id"))

#write to file
write.csv(ice_cream,"cleaned_ice_cream.csv")
write.csv(heights,"cleaned_heights.csv")
write.csv(heights,"cleaned_ice_cream_join_heights.csv")
```
