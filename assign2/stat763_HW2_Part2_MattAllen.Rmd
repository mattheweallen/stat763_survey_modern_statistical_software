...
### Data for the plots was filtered to range 4 feet (48 inches) inches to 8 feet (96 inches)
Row
-----------------------------------------------------------------------
...
p + geom_boxplot() + 
  labs(title="Student Height", subtitle="by Number One Ice Cream Preference")
```
