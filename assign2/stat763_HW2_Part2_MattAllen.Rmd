...
g <- ggplot(student_data_ice_cream, aes(Preference_1))
...
g <- ggplot(student_data_ice_cream, aes(Preference_2))
g + geom_bar(aes(fill=sex), width = 0.5) + 
  theme(axis.text.x = element_text(angle=65, vjust=0.6)) + 
  labs(title="Histogram on Categorical Variable", 
       subtitle="Manufacturer across Vehicle Classes") 

g <- ggplot(student_data_ice_cream, aes(Preference_3))
g + geom_bar(aes(fill=sex), width = 0.5) + 
  theme(axis.text.x = element_text(angle=65, vjust=0.6)) + 
  labs(title="Histogram on Third Ice Cream Preference", 
